...
Write-ColorOutput "   pipx install git+https://github.com/juliochwd/bps-stat-agent.git" -Color "Green"
Write-Host ""
...
Write-ColorOutput "   bps-stat-agent                              # Use current directory" -Color "Green"
Write-ColorOutput "   bps-stat-agent --workspace C:\path\to\project # Specify workspace" -Color "Green"
Write-ColorOutput "   bps-stat-agent --help                      # Show help" -Color "Green"
Write-Host ""
