# BPS Stat Agent Configuration Setup Script for Windows
...
$CONFIG_DIR = Join-Path $env:USERPROFILE ".bps-stat-agent\config"

Write-ColorOutput "==================================================" -Color "Cyan"
Write-ColorOutput "   BPS Stat Agent Configuration Setup" -Color "Cyan"
Write-ColorOutput "==================================================" -Color "Cyan"
Write-Host ""
...
if (Test-Path $CONFIG_DIR) {
    ...
    $BACKUP_DIR = Join-Path $env:USERPROFILE ".bps-stat-agent\config.backup.$timestamp"
...
Write-Host ""
Write-ColorOutput "1. Install BPS Stat Agent:" -Color "Yellow"
Write-ColorOutput "   uv tool install git+https://github.com/juliochwd/bps-stat-agent.git" -Color "Green"
Write-Host ""
Write-ColorOutput "2. Run the setup wizard:" -Color "Yellow"
Write-ColorOutput "   bpsagent setup" -Color "Green"
Write-Host ""
Write-ColorOutput "3. Start using BPS Stat Agent:" -Color "Yellow"
Write-ColorOutput "   bpsagent                                    # Interactive mode" -Color "Green"
Write-ColorOutput "   bpsagent --task `"Cari data inflasi NTT`"   # Non-interactive" -Color "Green"
Write-ColorOutput "   bpsagent --help                             # Show help" -Color "Green"
Write-Host ""
